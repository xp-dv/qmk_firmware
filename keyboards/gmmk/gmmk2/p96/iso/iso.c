...
led_config_t g_led_config = { {
    ...
    { 3, 21, 39, 57, 73, NO_LED, 17, 97},
    { 4, 22, 40, 58, 74, NO_LED, 32, 98},
    { 5, 23, 41, 59, 75, NO_LED, 33, 99},
    { 6, 24, 42, 60, 76, 91, 34, 84},
    { 7, 25, 43, 61, 77, NO_LED, 35, 85},
    { 8, 26, 44, 62, 78, NO_LED, 50, 86},
    { 9, 27, 45, 63, 79, 92, 51, 87},
    {10, 28, 46, 64, 80, 93, 52, 67},
    {11, 29, 47, 65, 81, NO_LED, 53, 68},
    {12, 30, 48, 66, NO_LED, 94, NO_LED, 69},
    {13, 31, NO_LED, 49, 82, NO_LED, NO_LED, NO_LED}
}, {
    { 11,    0}, //   0, k00, Esc
    { 22,    0}, //   1, k10, F1
    { 33,    0}, //   2, k20, F2
